...
img_size_bin = '../../build/tools/get_image_size'
...
if len(sys.argv)-1 != 2:
    print("Use this tool to test DispNet on images\n"
          ...
          "    ./demo_dispnet.py IMAGE1 IMAGE2\n"
          "\n"
          "Usage for a pair of image lists (must end with .txt):\n"
          "    ./demo_dispnet.py LIST1.TXT LIST2.TXT\n")
    sys.exit(1)
...
args = [caffe_bin, 'test', '-model', 'tmp/deploy.prototxt',
        '-weights', 'model/DispNetCorr1D_CVPR2016.caffemodel',
...
print('\nThe resulting disparity is stored in dispnet-corr1d-pred-NNNNNNN.flo')
